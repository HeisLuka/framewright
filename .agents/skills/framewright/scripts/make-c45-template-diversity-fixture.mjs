...
const narrative={
  ...
  roles:plan.roles.map(role=>({role:role.role,text:roleText(role,book),start_frame:role.start_frame,end_frame:role.end_frame})),
};
...
const selected=[],executionSelections={},variantRows=[];
