...
export function validateObservationIR(observation){
  ...
  if(observation.observation_id){const {observation_id,...projection}=observation;const expected=`nbobs1_${sha256Canonical(projection)}`;if(observation_id!==expected)errors.push(`observation_id mismatch expected ${expected}`);}
